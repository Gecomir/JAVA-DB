...
public enum Messages {
    ...
    public static final String VALID_COUNTRY_SUCCESS = "Successfully imported country %s - %s%n";
    ...
    public static final String VALID_FORECAST_FORMAT = "Successfully imported forecast %s - %d%n";
}
